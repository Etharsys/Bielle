...
int main(int argc, char** argv) {
    ...
    while(!done) {
        ...
        if (kmove == SDLK_z) {
            std::cout << "mov up" << std::endl;
            camera.moveFront(+.1);
        } else if (kmove == SDLK_s) {
            std::cout << "mov down" << std::endl;
            camera.moveFront(-.1);
        } else if (kmove == SDLK_q) {
            std::cout << "mov left" << std::endl;
            camera.moveLeft(+.1);
        } else if (kmove == SDLK_d) {
            std::cout << "mov right" << std::endl;
            camera.moveLeft(-.1);
        }
        ...
        if (y < paddingY) {
            std::cout << "rot up" << std::endl;
            camera.rotateUp(+1.);
        } else if (y > height - paddingY) {

            std::cout << "rot down" << std::endl;
            camera.rotateUp(-1.);
        }
