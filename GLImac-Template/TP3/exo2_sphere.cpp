...
int main(int argc, char** argv) {
    ...
    GLint uTextureEarth = glGetUniformLocation(program.getGLId(), "uTexture");
    GLint uTextureCloud = glGetUniformLocation(program.getGLId(), "uTextureCloud");
    ...
    while(!done) {
        ...
        glBindVertexArray(vao); 
            ...
            glBindTexture(GL_TEXTURE_2D, textEarth);
                ...
                glBindTexture(GL_TEXTURE_2D, textCloud);
                    glUniform1i(uTextureEarth, 0);
                    glUniform1i(uTextureCloud, 1);
